...
class iBOTLoss(nn.Module):
    def __init__(self, out_dim, patch_out_dim, ngcrops, nlcrops, warmup_teacher_temp, 
                 ...
                 lambda1=1.0, lambda2=1.0, mim_start_epoch=0, length=1000):
        super().__init__()
...
class LightningWrapper(pl.LightningModule):
    ...
    def _save_snapshot(self):
        ...
        torch.save(snapshot, f"{self.snapshot_path}/model_{self.current_epoch}_{self.length}_4l_308_512_noiseandTL.pt")
...
def pretrain_main(cgf):
    ...
    wandb_logger = WandbLogger(dir="./wandb/", project="Contrastive_Pretrain", entity='tonyu', name=f'Pretraining_{cfg.Pretraining.training.max_len}_4l_{cfg.Pretraining.SwanDNA.embedding_size}_{cfg.Pretraining.SwanDNA.hidden_size}')
